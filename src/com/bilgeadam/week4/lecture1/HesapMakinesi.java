...
public class HesapMakinesi {
	...
	public static void main(String[] args) {
		...
		3- Bölme
		4- Çarpma
		5- EBOB ve EKOK hesaplama.
		0- Çıkış

		4 işlem yaparken kullanıcı "=" girene kadar işlem gerçekleştirilmeye devam edecek. "=" yazıldığı zaman sonucu gösterip ana menüye dönecek.
		EBOB ve EKOK için kullanıcıdan 2 sayı alınacak, bu sayıların EBOB ve EKOK'ları bulunacak.
		...
		SayiKontrol sınıfımız, girilen string'in nümerik bir değer olup olmadığını kontrol edecek kontrol sınıfımız olacak.
		...
		Sonrasında Character.isDigit(); metodunu kullanabiliriz. Bu metot bize true ya da false bir değer dönecektir.
